...
const SearchBar = () => {
  ...
  return (
    <>
    <Form onSubmit={(e) => searchMovie(e)} className="d-flex justify-content-center align-items-center flex-grow-1">
            <Form.Control 
                placeholder='Search' 
                className='w-25'
                value={input}
            ...
            <Button type='submit' variant="outline-secondary">
               {loading ? <Spinner animation="border" size='sm'/> : <FaSearch size={19} />} 
            </Button>
        </Form>
        <Offcanvas data-bs-theme="dark" show={offCanvasShow} onHide={handleClose} placement='end' >
        ...
        <ListGroup>
          ...
          searchResults.map(result => (
            ...
            <div>
                ...
                <h6>{result?.release_date ? result.release_date.slice(0, 4) : '' }</h6>
            </div>
            </ListGroup.Item>
          ))}
        </ListGroup>
