    ...
    <>
      <div className='vh-100 bg-dark background-image d-flex align-items-center justify-content-center' style={backgroundStyle}>
        <Container fluid="md" className="rounded bg-dark " >
          ...
          {
            postError ? <Row className="px-3 d-flex justify-content-center align-items-center">
            <Alert className="w-50 h-50"  data-bs-theme="dark" variant="danger">{postError}</Alert>
          </Row> :
          <></>
          }
          <Row className="px-3">
              <Col>
              <Form.Control data-bs-theme="dark" placeholder='Add a comment...' value={input} onChange={handleInputChange} as="textarea" rows={1} />
              </Col>
              <Col lg="1" xs="2">
